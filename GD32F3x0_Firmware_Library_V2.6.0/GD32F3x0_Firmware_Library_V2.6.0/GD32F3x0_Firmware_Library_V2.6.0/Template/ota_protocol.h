/*!
    ...
    0x08001C00              升级标志（第七页）
    0x08002000 - 0x08008BFF  App 运行区 (27KB)
    0x08008C00 - 0x0800F7FF  下载区 (27KB)
    0x0800F800 - 0x0800FFFF  数据分区 (2KB) — OTA 升级不触碰
*/
...
/*
 * 升级标志存储在 Bootloader 区第七页（0x08001C00），
 * Bootloader 编译约 6.86KB（结束于 0x08001B6C），第七页空闲可用。
 * Bootloader 启动时读取此地址的魔数，判断是否有待安装的固件。
 */
#define OTA_FLAG_ADDR       0x08001C00U  /* 升级标志存储地址（BL 区第七页） */
